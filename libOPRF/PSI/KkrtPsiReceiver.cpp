...
namespace osuCrypto
{
    ...
    void KkrtPsiReceiver::init(u64 senderSize, u64 recverSize, u64 statSecParam, std::vector<Channel> chls, NcoOtExtReceiver& otRecv, block seed)
    {
    ...
    void KkrtPsiReceiver::sendInput(std::vector<block> inputs, std::vector<Channel> chls)
    {
